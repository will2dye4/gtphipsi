"""URL configuration for the gtphipsi.forums package.

All URIs beginning with '/forums/' are routed to this URL configuration. All such pages require authentication.
...
urlpatterns = patterns('gtphipsi.forums.views',
    ...
    url(r'^my-threads/$', 'my_threads', name='my_threads'),
